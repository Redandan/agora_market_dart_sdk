...
# **searchDisputes1**
> PageDispute searchDisputes1(pageable, buyerId, sellerId, status, type, startDate, endDate)
...
try {
    final result = api_instance.searchDisputes1(pageable, buyerId, sellerId, status, type, startDate, endDate);
    print(result);
} catch (e) {
