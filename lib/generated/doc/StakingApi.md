...
[**searchStakings**](StakingApi.md#searchstakings) | **POST** /staking/search | 管理員搜尋質押記錄
...
# **searchStakings**
> PageStaking searchStakings(stakingSearchParam, page, size)
...
final api_instance = StakingApi();
final stakingSearchParam = StakingSearchParam(); // StakingSearchParam | 
final page = 56; // int | 頁碼，從1開始
final size = 56; // int | 每頁數量

try {
    final result = api_instance.searchStakings(stakingSearchParam, page, size);
    print(result);
} catch (e) {
    print('Exception when calling StakingApi->searchStakings: $e\n');
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **stakingSearchParam** | [**StakingSearchParam**](StakingSearchParam.md)|  | 
