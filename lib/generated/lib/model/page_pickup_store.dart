...
class PagePickupStore {
  ...
  @override
  String toString() => 'PagePickupStore[totalPages=$totalPages, totalElements=$totalElements, sort=$sort, numberOfElements=$numberOfElements, first=$first, last=$last, pageable=$pageable, size=$size, content=$content, number=$number, empty=$empty]';
