...
class PagePickupStore {
  ...
  @override
  String toString() => 'PagePickupStore[totalElements=$totalElements, totalPages=$totalPages, size=$size, content=$content, number=$number, sort=$sort, first=$first, last=$last, numberOfElements=$numberOfElements, pageable=$pageable, empty=$empty]';
