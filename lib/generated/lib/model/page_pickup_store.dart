...
class PagePickupStore {
  ...
  @override
  String toString() => 'PagePickupStore[totalPages=$totalPages, totalElements=$totalElements, sort=$sort, pageable=$pageable, numberOfElements=$numberOfElements, first=$first, last=$last, size=$size, content=$content, number=$number, empty=$empty]';
