...
class AdminStoreSummaryResponse {
  /// Returns a new [AdminStoreSummaryResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AdminStoreSummaryResponse &&
    other.id == id &&
    other.name == name &&
  ...
  @override
  String toString() => 'AdminStoreSummaryResponse[id=$id, name=$name, description=$description, isActive=$isActive, viewCount=$viewCount, rating=$rating, ratingCount=$ratingCount, creditLevel=$creditLevel, productCount=$productCount, orderCount=$orderCount, totalSales=$totalSales, averageRating=$averageRating, responseRate=$responseRate, timeZone=$timeZone, logoUrl=$logoUrl, coverImageUrl=$coverImageUrl, createdAt=$createdAt, updatedAt=$updatedAt]';
  ...
  /// Returns a new [AdminStoreSummaryResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AdminStoreSummaryResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AdminStoreSummaryResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AdminStoreSummaryResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AdminStoreSummaryResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AdminStoreSummaryResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AdminStoreSummaryResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AdminStoreSummaryResponse> mapFromJson(dynamic json) {
    final map = <String, AdminStoreSummaryResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AdminStoreSummaryResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AdminStoreSummaryResponse-objects as value to a dart map
  static Map<String, List<AdminStoreSummaryResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AdminStoreSummaryResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AdminStoreSummaryResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
