...
class PageStaking {
  ...
  @override
  String toString() => 'PageStaking[totalPages=$totalPages, totalElements=$totalElements, last=$last, numberOfElements=$numberOfElements, first=$first, pageable=$pageable, size=$size, content=$content, number=$number, sort=$sort, empty=$empty]';
