...
class PageStaking {
  ...
  @override
  String toString() => 'PageStaking[totalElements=$totalElements, totalPages=$totalPages, sort=$sort, size=$size, content=$content, number=$number, numberOfElements=$numberOfElements, pageable=$pageable, first=$first, last=$last, empty=$empty]';
