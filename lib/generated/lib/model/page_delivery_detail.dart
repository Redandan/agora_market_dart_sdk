...
class PageDeliveryDetail {
  ...
  @override
  String toString() => 'PageDeliveryDetail[totalElements=$totalElements, totalPages=$totalPages, size=$size, content=$content, number=$number, sort=$sort, numberOfElements=$numberOfElements, pageable=$pageable, first=$first, last=$last, empty=$empty]';
