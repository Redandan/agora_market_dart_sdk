...
class DeliveryDetail {
  ...
  /// 配送方式
  DeliveryDetailDeliveryTypeEnum? deliveryType;
  ...
  static DeliveryDetail? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return DeliveryDetail(
        ...
        deliveryType: DeliveryDetailDeliveryTypeEnum.fromJson(json[r'deliveryType']),
...
/// 配送方式
class DeliveryDetailDeliveryTypeEnum {
  /// Instantiate a new enum with the provided [value].
  const DeliveryDetailDeliveryTypeEnum._(this.value);
  ...
  static const DELIVERY = DeliveryDetailDeliveryTypeEnum._(r'DELIVERY');
  static const LOGISTICS = DeliveryDetailDeliveryTypeEnum._(r'LOGISTICS');
  static const PICKUP = DeliveryDetailDeliveryTypeEnum._(r'PICKUP');
  static const unknownDefaultOpenApi = DeliveryDetailDeliveryTypeEnum._(r'unknown_default_open_api');

  /// List of all possible values in this [enum][DeliveryDetailDeliveryTypeEnum].
  static const values = <DeliveryDetailDeliveryTypeEnum>[
    DELIVERY,
    LOGISTICS,
    PICKUP,
  ...
  static DeliveryDetailDeliveryTypeEnum? fromJson(dynamic value) => DeliveryDetailDeliveryTypeEnumTypeTransformer().decode(value);

  static List<DeliveryDetailDeliveryTypeEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DeliveryDetailDeliveryTypeEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DeliveryDetailDeliveryTypeEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [DeliveryDetailDeliveryTypeEnum] to String,
/// and [decode] dynamic data back to [DeliveryDetailDeliveryTypeEnum].
class DeliveryDetailDeliveryTypeEnumTypeTransformer {
  factory DeliveryDetailDeliveryTypeEnumTypeTransformer() => _instance ??= const DeliveryDetailDeliveryTypeEnumTypeTransformer._();

  const DeliveryDetailDeliveryTypeEnumTypeTransformer._();

  String encode(DeliveryDetailDeliveryTypeEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a DeliveryDetailDeliveryTypeEnum.
  ///
  ...
  DeliveryDetailDeliveryTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'DELIVERY': return DeliveryDetailDeliveryTypeEnum.DELIVERY;
        case r'LOGISTICS': return DeliveryDetailDeliveryTypeEnum.LOGISTICS;
        case r'PICKUP': return DeliveryDetailDeliveryTypeEnum.PICKUP;
        case r'unknown_default_open_api': return DeliveryDetailDeliveryTypeEnum.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
  ...
  /// Singleton [DeliveryDetailDeliveryTypeEnumTypeTransformer] instance.
  static DeliveryDetailDeliveryTypeEnumTypeTransformer? _instance;
}
