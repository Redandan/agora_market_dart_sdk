...
class CartItem {
  ...
  @override
  String toString() => 'CartItem[id=$id, userId=$userId, productId=$productId, productName=$productName, productImage=$productImage, quantity=$quantity, createdAt=$createdAt, updatedAt=$updatedAt]';
