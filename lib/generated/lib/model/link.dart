...
class Link {
  ...
  int get hashCode =>
    ...
    (templated == null ? 0 : templated!.hashCode);

  @override
  String toString() => 'Link[href=$href, templated=$templated]';
  ...
  static Link? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Link(
        ...
        templated: mapValueOfType<bool>(json, r'templated'),
      );
    }
    return null;
  }
