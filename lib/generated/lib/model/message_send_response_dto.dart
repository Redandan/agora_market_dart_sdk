...
class MessageSendResponseDTO {
  ...
  @override
  String toString() => 'MessageSendResponseDTO[messageId=$messageId, status=$status, sseStatus=$sseStatus, receiverOnline=$receiverOnline, sentAt=$sentAt, errorMessage=$errorMessage]';
