...
class PageAutoReplyConfig {
  ...
  @override
  String toString() => 'PageAutoReplyConfig[totalElements=$totalElements, totalPages=$totalPages, sort=$sort, first=$first, last=$last, pageable=$pageable, numberOfElements=$numberOfElements, size=$size, content=$content, number=$number, empty=$empty]';
