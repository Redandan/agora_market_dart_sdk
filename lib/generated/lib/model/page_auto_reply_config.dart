...
class PageAutoReplyConfig {
  ...
  @override
  String toString() => 'PageAutoReplyConfig[totalElements=$totalElements, totalPages=$totalPages, sort=$sort, pageable=$pageable, numberOfElements=$numberOfElements, first=$first, last=$last, size=$size, content=$content, number=$number, empty=$empty]';
