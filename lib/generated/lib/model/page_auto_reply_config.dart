...
class PageAutoReplyConfig {
  ...
  @override
  String toString() => 'PageAutoReplyConfig[totalPages=$totalPages, totalElements=$totalElements, sort=$sort, last=$last, pageable=$pageable, numberOfElements=$numberOfElements, first=$first, size=$size, content=$content, number=$number, empty=$empty]';
