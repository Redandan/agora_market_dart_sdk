...
class PageAutoReplyConfig {
  ...
  @override
  String toString() => 'PageAutoReplyConfig[totalElements=$totalElements, totalPages=$totalPages, sort=$sort, size=$size, content=$content, number=$number, pageable=$pageable, numberOfElements=$numberOfElements, first=$first, last=$last, empty=$empty]';
