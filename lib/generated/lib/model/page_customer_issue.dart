...
class PageCustomerIssue {
  ...
  @override
  String toString() => 'PageCustomerIssue[totalElements=$totalElements, totalPages=$totalPages, sort=$sort, size=$size, content=$content, number=$number, pageable=$pageable, numberOfElements=$numberOfElements, first=$first, last=$last, empty=$empty]';
