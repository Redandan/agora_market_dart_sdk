...
class PageCustomerIssue {
  ...
  @override
  String toString() => 'PageCustomerIssue[totalElements=$totalElements, totalPages=$totalPages, sort=$sort, first=$first, last=$last, numberOfElements=$numberOfElements, pageable=$pageable, size=$size, content=$content, number=$number, empty=$empty]';
