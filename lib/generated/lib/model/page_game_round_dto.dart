...
class PageGameRoundDTO {
  ...
  @override
  String toString() => 'PageGameRoundDTO[totalElements=$totalElements, totalPages=$totalPages, size=$size, content=$content, number=$number, sort=$sort, numberOfElements=$numberOfElements, pageable=$pageable, first=$first, last=$last, empty=$empty]';
