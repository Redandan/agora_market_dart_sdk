...
class PageOrder {
  ...
  @override
  String toString() => 'PageOrder[totalPages=$totalPages, totalElements=$totalElements, sort=$sort, first=$first, last=$last, numberOfElements=$numberOfElements, pageable=$pageable, size=$size, content=$content, number=$number, empty=$empty]';
