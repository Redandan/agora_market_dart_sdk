...
class PageOrder {
  ...
  @override
  String toString() => 'PageOrder[totalPages=$totalPages, totalElements=$totalElements, pageable=$pageable, first=$first, last=$last, numberOfElements=$numberOfElements, size=$size, content=$content, number=$number, sort=$sort, empty=$empty]';
