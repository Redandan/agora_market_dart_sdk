...
class PageOrder {
  ...
  @override
  String toString() => 'PageOrder[totalElements=$totalElements, totalPages=$totalPages, numberOfElements=$numberOfElements, pageable=$pageable, first=$first, last=$last, size=$size, content=$content, number=$number, sort=$sort, empty=$empty]';
