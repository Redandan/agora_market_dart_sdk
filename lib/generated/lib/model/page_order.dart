...
class PageOrder {
  ...
  @override
  String toString() => 'PageOrder[totalElements=$totalElements, totalPages=$totalPages, pageable=$pageable, numberOfElements=$numberOfElements, first=$first, last=$last, size=$size, content=$content, number=$number, sort=$sort, empty=$empty]';
