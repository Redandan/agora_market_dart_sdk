...
class PageOrder {
  ...
  @override
  String toString() => 'PageOrder[totalElements=$totalElements, totalPages=$totalPages, sort=$sort, size=$size, content=$content, number=$number, numberOfElements=$numberOfElements, pageable=$pageable, last=$last, first=$first, empty=$empty]';
