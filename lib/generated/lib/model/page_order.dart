...
class PageOrder {
  ...
  @override
  String toString() => 'PageOrder[totalElements=$totalElements, totalPages=$totalPages, sort=$sort, first=$first, last=$last, pageable=$pageable, numberOfElements=$numberOfElements, size=$size, content=$content, number=$number, empty=$empty]';
