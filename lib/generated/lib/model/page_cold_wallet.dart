...
class PageColdWallet {
  ...
  @override
  String toString() => 'PageColdWallet[totalPages=$totalPages, totalElements=$totalElements, sort=$sort, size=$size, content=$content, number=$number, numberOfElements=$numberOfElements, pageable=$pageable, first=$first, last=$last, empty=$empty]';
