...
class PageColdWallet {
  ...
  @override
  String toString() => 'PageColdWallet[totalPages=$totalPages, totalElements=$totalElements, sort=$sort, last=$last, numberOfElements=$numberOfElements, pageable=$pageable, first=$first, size=$size, content=$content, number=$number, empty=$empty]';
