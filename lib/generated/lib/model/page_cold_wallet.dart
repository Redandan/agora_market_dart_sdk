...
class PageColdWallet {
  ...
  @override
  String toString() => 'PageColdWallet[totalPages=$totalPages, totalElements=$totalElements, sort=$sort, pageable=$pageable, numberOfElements=$numberOfElements, last=$last, first=$first, size=$size, content=$content, number=$number, empty=$empty]';
