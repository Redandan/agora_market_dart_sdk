...
class PagePromoCode {
  ...
  @override
  String toString() => 'PagePromoCode[totalPages=$totalPages, totalElements=$totalElements, first=$first, last=$last, numberOfElements=$numberOfElements, pageable=$pageable, size=$size, content=$content, number=$number, sort=$sort, empty=$empty]';
