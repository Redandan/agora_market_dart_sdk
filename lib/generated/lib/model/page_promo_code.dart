...
class PagePromoCode {
  ...
  @override
  String toString() => 'PagePromoCode[totalElements=$totalElements, totalPages=$totalPages, sort=$sort, last=$last, numberOfElements=$numberOfElements, pageable=$pageable, first=$first, size=$size, content=$content, number=$number, empty=$empty]';
