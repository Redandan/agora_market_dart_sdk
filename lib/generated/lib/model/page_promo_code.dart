...
class PagePromoCode {
  ...
  @override
  String toString() => 'PagePromoCode[totalPages=$totalPages, totalElements=$totalElements, sort=$sort, last=$last, pageable=$pageable, numberOfElements=$numberOfElements, first=$first, size=$size, content=$content, number=$number, empty=$empty]';
