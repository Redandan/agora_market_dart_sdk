...
class PasskeySignupVerifyResponse {
  ...
  @override
  String toString() => 'PasskeySignupVerifyResponse[loginResult=$loginResult, credentialId=$credentialId, rpId=$rpId, passkeyCredentialId=$passkeyCredentialId, discoverable=$discoverable, backupEligible=$backupEligible, backedUp=$backedUp]';
