...
class PushTestResponseDTO {
  ...
  @override
  String toString() => 'PushTestResponseDTO[success=$success, sentCount=$sentCount, successCount=$successCount, failureCount=$failureCount, message=$message, errorCode=$errorCode, errorDetails=$errorDetails]';
