...
class PageDispute {
  ...
  @override
  String toString() => 'PageDispute[totalPages=$totalPages, totalElements=$totalElements, last=$last, first=$first, pageable=$pageable, numberOfElements=$numberOfElements, size=$size, content=$content, number=$number, sort=$sort, empty=$empty]';
