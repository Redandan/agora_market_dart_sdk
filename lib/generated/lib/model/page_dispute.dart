...
class PageDispute {
  ...
  @override
  String toString() => 'PageDispute[totalPages=$totalPages, totalElements=$totalElements, numberOfElements=$numberOfElements, first=$first, last=$last, pageable=$pageable, size=$size, content=$content, number=$number, sort=$sort, empty=$empty]';
