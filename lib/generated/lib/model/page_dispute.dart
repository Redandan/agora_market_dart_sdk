...
class PageDispute {
  ...
  @override
  String toString() => 'PageDispute[totalPages=$totalPages, totalElements=$totalElements, sort=$sort, first=$first, numberOfElements=$numberOfElements, pageable=$pageable, last=$last, size=$size, content=$content, number=$number, empty=$empty]';
