...
class PageUserAddress {
  ...
  @override
  String toString() => 'PageUserAddress[totalElements=$totalElements, totalPages=$totalPages, sort=$sort, first=$first, last=$last, pageable=$pageable, numberOfElements=$numberOfElements, size=$size, content=$content, number=$number, empty=$empty]';
