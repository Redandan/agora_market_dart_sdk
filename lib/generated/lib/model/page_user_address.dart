...
class PageUserAddress {
  ...
  @override
  String toString() => 'PageUserAddress[totalElements=$totalElements, totalPages=$totalPages, sort=$sort, first=$first, numberOfElements=$numberOfElements, pageable=$pageable, last=$last, size=$size, content=$content, number=$number, empty=$empty]';
