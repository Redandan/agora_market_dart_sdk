...
class PageUserAddress {
  ...
  @override
  String toString() => 'PageUserAddress[totalPages=$totalPages, totalElements=$totalElements, sort=$sort, first=$first, last=$last, numberOfElements=$numberOfElements, pageable=$pageable, size=$size, content=$content, number=$number, empty=$empty]';
