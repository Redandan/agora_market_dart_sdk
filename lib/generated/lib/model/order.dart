  ...
  static Order? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Order(
        ...
        shippingFee: json[r'shippingFee'] != null ? num.parse('${json[r'shippingFee']}') : 0,
        productPrice: json[r'productPrice'] != null ? num.parse('${json[r'productPrice']}') : 0,
        orderAmount: json[r'orderAmount'] != null ? num.parse('${json[r'orderAmount']}') : 0,
        ...
        refundAmount: json[r'refundAmount'] != null ? num.parse('${json[r'refundAmount']}') : null,
        refundOfferExpiresAt: mapDateTime(json, r'refundOfferExpiresAt', r''),
        reviewedAt: mapDateTime(json, r'reviewedAt', r''),
        originalPrice: json[r'originalPrice'] != null ? num.parse('${json[r'originalPrice']}') : null,
        ...
        originalShippingFee: json[r'originalShippingFee'] != null ? num.parse('${json[r'originalShippingFee']}') : null,
...
class OrderStatusEnum {
  ...
  static const PURCHASE_IN_PROGRESS = OrderStatusEnum._(r'PURCHASE_IN_PROGRESS');
  static const PROOF_SUBMITTED = OrderStatusEnum._(r'PROOF_SUBMITTED');
  static const BUYER_CONFIRMED = OrderStatusEnum._(r'BUYER_CONFIRMED');
  ...
  OrderStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'PURCHASE_IN_PROGRESS': return OrderStatusEnum.PURCHASE_IN_PROGRESS;
        case r'PROOF_SUBMITTED': return OrderStatusEnum.PROOF_SUBMITTED;
        case r'BUYER_CONFIRMED': return OrderStatusEnum.BUYER_CONFIRMED;
