...
class PageRecharge {
  ...
  @override
  String toString() => 'PageRecharge[totalElements=$totalElements, totalPages=$totalPages, first=$first, last=$last, numberOfElements=$numberOfElements, pageable=$pageable, size=$size, content=$content, number=$number, sort=$sort, empty=$empty]';
