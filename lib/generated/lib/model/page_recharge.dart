...
class PageRecharge {
  ...
  @override
  String toString() => 'PageRecharge[totalPages=$totalPages, totalElements=$totalElements, sort=$sort, last=$last, numberOfElements=$numberOfElements, pageable=$pageable, first=$first, size=$size, content=$content, number=$number, empty=$empty]';
