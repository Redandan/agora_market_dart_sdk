...
class PageRecharge {
  ...
  @override
  String toString() => 'PageRecharge[totalElements=$totalElements, totalPages=$totalPages, pageable=$pageable, first=$first, last=$last, numberOfElements=$numberOfElements, size=$size, content=$content, number=$number, sort=$sort, empty=$empty]';
