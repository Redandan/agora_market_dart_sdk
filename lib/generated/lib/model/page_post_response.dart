...
class PagePostResponse {
  ...
  @override
  String toString() => 'PagePostResponse[totalPages=$totalPages, totalElements=$totalElements, sort=$sort, pageable=$pageable, numberOfElements=$numberOfElements, last=$last, first=$first, size=$size, content=$content, number=$number, empty=$empty]';
