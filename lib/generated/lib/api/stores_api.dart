...
class StoresApi {
  ...
  ///   商店ID
  Future<Response> removeStoreCoverWithHttpInfo(int storeId,) async {
    // ignore: prefer_const_declarations
    final path = r'/stores/{storeId}/cover'
  ...
  /// * [int] storeId (required):
  ///   商店ID
  Future<StoreResponseDTO?> removeStoreCover(int storeId,) async {
    final response = await removeStoreCoverWithHttpInfo(storeId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [int] storeId (required):
  ///   商店ID
  Future<Response> removeStoreLogoWithHttpInfo(int storeId,) async {
    // ignore: prefer_const_declarations
    final path = r'/stores/{storeId}/logo'
      .replaceAll('{storeId}', storeId.toString());
  ...
  /// * [int] storeId (required):
  ///   商店ID
  Future<StoreResponseDTO?> removeStoreLogo(int storeId,) async {
    final response = await removeStoreLogoWithHttpInfo(storeId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///   商店ID
  ///
  /// * [StoreImageUploadParam] storeImageUploadParam (required):
  Future<Response> uploadStoreCoverWithHttpInfo(int storeId, StoreImageUploadParam storeImageUploadParam,) async {
    // ignore: prefer_const_declarations
    final path = r'/stores/{storeId}/cover/upload'
      .replaceAll('{storeId}', storeId.toString());

    // ignore: prefer_final_locals
    Object? postBody = storeImageUploadParam;
  ...
  ///
  /// * [StoreImageUploadParam] storeImageUploadParam (required):
  Future<StoreResponseDTO?> uploadStoreCover(int storeId, StoreImageUploadParam storeImageUploadParam,) async {
    final response = await uploadStoreCoverWithHttpInfo(storeId, storeImageUploadParam,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [StoreImageUploadParam] storeImageUploadParam (required):
  Future<Response> uploadStoreLogoWithHttpInfo(int storeId, StoreImageUploadParam storeImageUploadParam,) async {
    // ignore: prefer_const_declarations
    final path = r'/stores/{storeId}/logo/upload'
      .replaceAll('{storeId}', storeId.toString());
  ...
  ///
  /// * [StoreImageUploadParam] storeImageUploadParam (required):
  Future<StoreResponseDTO?> uploadStoreLogo(int storeId, StoreImageUploadParam storeImageUploadParam,) async {
    final response = await uploadStoreLogoWithHttpInfo(storeId, storeImageUploadParam,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
