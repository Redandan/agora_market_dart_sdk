...
class FlutterDeploymentApi {
  ...
  Future<List<AppVersion>?> getApps({ String? platform, bool? latest, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeWithAsync(responseBody, (dynamic value) => ApiClient.decodeGeneratedList(value, (dynamic item) => AppVersion.fromJson(item))) as List)
        .cast<AppVersion>()
