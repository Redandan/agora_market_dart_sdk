...
class PublicProductSeoControllerApi {
  ...
  /// Performs an HTTP 'GET /public/seo/feed.xml' operation and returns the [Response].
  Future<Response> atomFeedWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/public/seo/feed.xml';
  ...
  Future<String?> atomFeed() async {
    final response = await atomFeedWithHttpInfo();
