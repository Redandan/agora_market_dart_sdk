...
class LoginMethodsApi {
  ...
  Future<ApiResponseListLoginMethod?> getLoginMethods() async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeWithAsync(await _decodeBodyBytes(response), (dynamic value) => ApiResponseListLoginMethod.fromJson(value)) as ApiResponseListLoginMethod;
