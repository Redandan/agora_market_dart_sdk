...
class AdminDeliveryApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [DeliveryDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeliveryDetail>> assignDeliveryer({ 
    required String orderId,
    required int deliveryerId,
    ...
    return Response<DeliveryDetail>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [DeliveryDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeliveryDetail>> getDeliveryOrderDetail({ 
    required String orderId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<BuiltMap<String, JsonObject>>> getDeliveryStatistics({ 
    ...
    final _path = r'/admin/delivery/statistics';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Deliveryer] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Deliveryer>> getDeliveryerDetail({ 
    required int deliveryerId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<BuiltList<DeliveryDetail>>> searchDeliveryOrders({ 
    ...
    final _path = r'/admin/delivery/orders/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<Deliveryer>>> searchDeliveryers({ 
    ...
    final _path = r'/admin/delivery/deliveryers/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Deliveryer] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Deliveryer>> updateDeliveryerStatus({ 
    required int deliveryerId,
