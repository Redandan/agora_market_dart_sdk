...
class MemberOrdersApi {
  ...
  Future<Response<void>> cancelOrder({ 
    required OrderCancelParam orderCancelParam,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> confirmOrder({ 
    required OrderConfirmParam orderConfirmParam,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrderQueryResult>> getOrder({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageOrder>> searchOrdersByBuyer({ 
    required OrderSearchParam searchParam,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [PageOrder] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageOrder>> searchOrdersBySeller({ 
    required OrderSearchParam searchParam,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> shipOrder({ 
    required OrderShipParam orderShipParam,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> submitOrder({ 
    required OrderSumbitParam orderSumbitParam,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
