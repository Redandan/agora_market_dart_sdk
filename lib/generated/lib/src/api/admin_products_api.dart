...
class AdminProductsApi {
  ...
  Future<Response<Product>> getProductDetail({ 
...
_responseData = rawData == null ? null : deserialize<Product, Product>(rawData, 'Product', growable: true);
  ...
  Future<Response<Map<String, Object>>> getProductStatistics({ 
    ...
    final _path = r'/admin/products/statistics';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<Map<String, Object>, Object>(rawData, 'Map<String, Object>', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageProduct>> searchProducts({ 
    int? sellerId,
    String? status,
    String? category,
    DateTime? startDate,
    ...
    final _path = r'/admin/products/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<PageProduct, PageProduct>(rawData, 'PageProduct', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Product] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Product>> updateProductByAdmin({ 
    required int productId,
...
_responseData = rawData == null ? null : deserialize<Product, Product>(rawData, 'Product', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Product] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Product>> updateProductStatus({ 
    required int productId,
