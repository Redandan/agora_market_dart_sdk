...
class DefaultApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Recharge] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Recharge>> cancelRecharge({ 
...
_responseData = rawData == null ? null : deserialize<Recharge, Recharge>(rawData, 'Recharge', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Recharge] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Recharge>> completeRecharge({ 
    required String rechargeId,
...
_responseData = rawData == null ? null : deserialize<Recharge, Recharge>(rawData, 'Recharge', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Withdraw] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Withdraw>> completeWithdraw({ 
...
_responseData = rawData == null ? null : deserialize<Withdraw, Withdraw>(rawData, 'Withdraw', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Recharge] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Recharge>> createRecharge({ 
    required CreateRechargeParam createRechargeParam,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<Recharge, Recharge>(rawData, 'Recharge', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Withdraw] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Withdraw>> createWithdraw({ 
    required CreateWithdrawParam createWithdrawParam,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<Withdraw, Withdraw>(rawData, 'Withdraw', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Withdraw] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Withdraw>> failWithdraw({ 
    required String withdrawId,
...
_responseData = rawData == null ? null : deserialize<Withdraw, Withdraw>(rawData, 'Withdraw', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PageTransaction] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageTransaction>> getAdminTransactionList({ 
    required int userId,
...
_responseData = rawData == null ? null : deserialize<PageTransaction, PageTransaction>(rawData, 'PageTransaction', growable: true);
    ...
    return Response<PageTransaction>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
...
_responseData = rawData == null ? null : deserialize<Object, Object>(rawData, 'Object', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Recharge] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Recharge>> getRecharge({ 
    required String rechargeId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<Recharge, Recharge>(rawData, 'Recharge', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Recharge] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Recharge>> getRechargeByReceiveAddress({ 
...
_responseData = rawData == null ? null : deserialize<Recharge, Recharge>(rawData, 'Recharge', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Recharge] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Recharge>> getRechargeByTxHash({ 
    required String txHash,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<Recharge, Recharge>(rawData, 'Recharge', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PageRecharge] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageRecharge>> getRechargeHistory({ 
    required int userId,
    ...
    final _path = r'/recharge/history';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<PageRecharge, PageRecharge>(rawData, 'PageRecharge', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Transaction>> getTransactionById({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<Transaction, Transaction>(rawData, 'Transaction', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [PageTransaction] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageTransaction>> getTransactionList({ 
    required String token,
    required int page,
    required int size,
    CancelToken? cancelToken,
...
_responseData = rawData == null ? null : deserialize<PageTransaction, PageTransaction>(rawData, 'PageTransaction', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Withdraw] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Withdraw>> getWithdraw({ 
    required String withdrawId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<Withdraw, Withdraw>(rawData, 'Withdraw', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PageWithdraw] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageWithdraw>> getWithdrawHistory({ 
    required int userId,
    required Pageable pageable,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/withdraws/history';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
