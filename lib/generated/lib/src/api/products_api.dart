...
class ProductsApi {
  ...
  Future<Response<Product>> createProduct({ 
    required ProductCreateParam productCreateParam,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageProduct>> getMyProducts({ 
    required ProductSeachParam searchParam,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/products/my-products';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [PageProduct] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageProduct>> getProductsBySearch({ 
    required ProductSeachParam productSeachParam,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<Product>> updateProduct({ 
    required ProductUpdateParam productUpdateParam,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
