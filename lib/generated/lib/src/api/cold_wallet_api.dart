...
class ColdWalletApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ColdWallet] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ColdWallet>> createColdWallet({ 
    required ColdWallet coldWallet,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteColdWallet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PageColdWallet] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageColdWallet>> getColdWallets({ 
    ...
    return Response<PageColdWallet>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ColdWallet] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ColdWallet>> releaseColdWallet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
