...
class StakingApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Staking] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Staking>> applyStaking({ 
    num? body,
...
_responseData = rawData == null ? null : deserialize<Staking, Staking>(rawData, 'Staking', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PageStaking] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageStaking>> getStakingList({ 
    required int page,
    required int size,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = rawData == null ? null : deserialize<PageStaking, PageStaking>(rawData, 'PageStaking', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Staking] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Staking>> unfreezeStaking({ 
    required int stakingId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/staking/unfreeze';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
