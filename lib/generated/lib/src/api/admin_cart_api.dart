...
class AdminCartApi {
  ...
  Future<Response<void>> clearUserCart({ 
    required int userId,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CartSummaryDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CartSummaryDTO>> getCartSummary({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin/cart/summary';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<CartSummaryDTO>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PageCartItem] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageCartItem>> searchCarts({ 
    ...
    final _path = r'/admin/cart/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
