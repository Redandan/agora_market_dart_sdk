...
class AdminOrdersApi {
  ...
  Future<Response<void>> cancelOrderByAdmin({ 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OrderQueryResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrderQueryResult>> getOrderDetail({ 
    required String orderId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<OrderQueryResult, OrderQueryResult>(rawData, 'OrderQueryResult', growable: true);
    ...
    return Response<OrderQueryResult>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OrderStatisticsDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrderStatisticsDTO>> getOrderStatistics({ 
    DateTime? startDate,
    DateTime? endDate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/admin/orders/statistics';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<OrderStatisticsDTO, OrderStatisticsDTO>(rawData, 'OrderStatisticsDTO', growable: true);
    ...
    return Response<OrderStatisticsDTO>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PageOrder] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageOrder>> searchOrders({ 
    int? buyerId,
    int? sellerId,
    String? status,
    DateTime? startDate,
    ...
    final _path = r'/admin/orders/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
