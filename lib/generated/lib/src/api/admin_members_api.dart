...
class AdminMembersApi {
  ...
  Future<Response<User>> getMemberDetail({ 
...
_responseData = rawData == null ? null : deserialize<User, User>(rawData, 'User', growable: true);
  ...
  Future<Response<Map<String, Object>>> getMemberStatistics({ 
    ...
    final _path = r'/admin/members/statistics';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<Map<String, Object>, Object>(rawData, 'Map<String, Object>', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PageUser] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageUser>> searchMembers({ 
    String? status,
    DateTime? startDate,
    DateTime? endDate,
    int? page = 0,
    ...
    final _path = r'/admin/members/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<PageUser, PageUser>(rawData, 'PageUser', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> updateMemberByAdmin({ 
    required int memberId,
    required MemberUpdateParam memberUpdateParam,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<User, User>(rawData, 'User', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> updateMemberStatus({ 
    required int memberId,
