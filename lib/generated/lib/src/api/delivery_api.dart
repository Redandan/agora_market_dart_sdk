...
class DeliveryApi {
  ...
  Future<Response<Deliveryer>> currentStatus({ 
...
_responseData = rawData == null ? null : deserialize<Deliveryer, Deliveryer>(rawData, 'Deliveryer', growable: true);
  ...
  Future<Response<List<DeliveryDetail>>> getDeliveryHistory({ 
    ...
    final _path = r'/delivery/history';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<List<DeliveryDetail>, DeliveryDetail>(rawData, 'List<DeliveryDetail>', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Deliveryer] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Deliveryer>> updateDeliveryOrder({ 
    ...
    final _path = r'/delivery/update/order';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<Deliveryer, Deliveryer>(rawData, 'Deliveryer', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Deliveryer] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Deliveryer>> updateWorkingStatus({ 
    ...
    final _path = r'/delivery/update/status';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
