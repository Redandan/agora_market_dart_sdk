...
class StoresApi {
  ...
  Future<Response<Store>> getMyStore({ 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [StoreAnalyticsDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StoreAnalyticsDTO>> getStoreAnalytics({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/stores/analytics';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<StoreAnalyticsDTO>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PageProduct] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageProduct>> searchMyStoreProducts({ 
    String? keyword,
    int? categoryId,
    String? status,
    int? page = 0,
    ...
    final _path = r'/stores/products/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Store] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Store>> updateStore({ 
    required StoreUpdateParam storeUpdateParam,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
