...
class MemberCartApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CartItem] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CartItem>> addToCart({ 
...
_responseData = rawData == null ? null : deserialize<CartItem, CartItem>(rawData, 'CartItem', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PageCartItem>> getUserCart({ 
...
_responseData = rawData == null ? null : deserialize<PageCartItem, PageCartItem>(rawData, 'PageCartItem', growable: true);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> removeFromCart({ 
  ...
  /// Returns a [Future] containing a [Response] with a [CartItem] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CartItem>> updateQuantity({ 
    required int cartItemId,
    required int quantity,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
