...
abstract class PageCartItem implements Built<PageCartItem, PageCartItemBuilder> {
  ...
  BuiltList<CartItem>? get content;
  ...
  factory PageCartItem([void updates(PageCartItemBuilder b)]) = _$PageCartItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PageCartItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PageCartItem> get serializer => _$PageCartItemSerializer();
}

class _$PageCartItemSerializer implements PrimitiveSerializer<PageCartItem> {
  @override
  final Iterable<Type> types = const [PageCartItem, _$PageCartItem];

  @override
  final String wireName = r'PageCartItem';
  ...
  void _deserializeProperties(
    ...
    required PageCartItemBuilder result,
  ...
  @override
  PageCartItem deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PageCartItemBuilder();
