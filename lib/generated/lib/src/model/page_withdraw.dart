...
/// * [empty] 
@BuiltValue()
abstract class PageWithdraw implements Built<PageWithdraw, PageWithdrawBuilder> {
  ...
  BuiltList<Withdraw>? get content;
  ...
  factory PageWithdraw([void updates(PageWithdrawBuilder b)]) = _$PageWithdraw;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PageWithdrawBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PageWithdraw> get serializer => _$PageWithdrawSerializer();
}

class _$PageWithdrawSerializer implements PrimitiveSerializer<PageWithdraw> {
  @override
  final Iterable<Type> types = const [PageWithdraw, _$PageWithdraw];

  @override
  final String wireName = r'PageWithdraw';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.content != null) {
      ...
      yield serializers.serialize(
        object.content,
        specifiedType: const FullType(BuiltList, [FullType(Withdraw)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required PageWithdrawBuilder result,
  ...
  @override
  PageWithdraw deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PageWithdrawBuilder();
