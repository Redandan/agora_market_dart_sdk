...
/// * [empty] 
@BuiltValue()
abstract class PageRecharge implements Built<PageRecharge, PageRechargeBuilder> {
  ...
  BuiltList<Recharge>? get content;
  ...
  factory PageRecharge([void updates(PageRechargeBuilder b)]) = _$PageRecharge;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PageRechargeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PageRecharge> get serializer => _$PageRechargeSerializer();
}

class _$PageRechargeSerializer implements PrimitiveSerializer<PageRecharge> {
  @override
  final Iterable<Type> types = const [PageRecharge, _$PageRecharge];

  @override
  final String wireName = r'PageRecharge';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.content != null) {
      ...
      yield serializers.serialize(
        object.content,
        specifiedType: const FullType(BuiltList, [FullType(Recharge)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required PageRechargeBuilder result,
  ...
  @override
  PageRecharge deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PageRechargeBuilder();
