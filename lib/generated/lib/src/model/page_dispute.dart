...
/// * [empty] 
@BuiltValue()
abstract class PageDispute implements Built<PageDispute, PageDisputeBuilder> {
  ...
  factory PageDispute([void updates(PageDisputeBuilder b)]) = _$PageDispute;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PageDisputeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PageDispute> get serializer => _$PageDisputeSerializer();
}

class _$PageDisputeSerializer implements PrimitiveSerializer<PageDispute> {
  @override
  final Iterable<Type> types = const [PageDispute, _$PageDispute];

  @override
  final String wireName = r'PageDispute';
  ...
  void _deserializeProperties(
    ...
    required PageDisputeBuilder result,
  ...
  @override
  PageDispute deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PageDisputeBuilder();
