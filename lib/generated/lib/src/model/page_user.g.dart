...
class _$PageUser extends PageUser {
  ...
  factory _$PageUser([void Function(PageUserBuilder)? updates]) =>
      (PageUserBuilder()..update(updates))._build();
  ...
  @override
  PageUserBuilder toBuilder() => PageUserBuilder()..replace(this);
...
class PageUserBuilder implements Builder<PageUser, PageUserBuilder> {
  ...
  ListBuilder<User> get content => _$this._content ??= ListBuilder<User>();
