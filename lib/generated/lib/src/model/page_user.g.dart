...
class _$PageUser extends PageUser {
  @override
  ...
  factory _$PageUser([void Function(PageUserBuilder)? updates]) =>
      (new PageUserBuilder()..update(updates))._build();
  ...
  @override
  PageUser rebuild(void Function(PageUserBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PageUserBuilder toBuilder() => new PageUserBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PageUser &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PageUser')
...
class PageUserBuilder implements Builder<PageUser, PageUserBuilder> {
  _$PageUser? _$v;
  ...
  ListBuilder<User>? _content;
  ListBuilder<User> get content => _$this._content ??= new ListBuilder<User>();
  set content(ListBuilder<User>? content) => _$this._content = content;
  ...
  PageUserBuilder() {
    PageUser._defaults(this);
  }

  PageUserBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(PageUser other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PageUser;
  }

  @override
  void update(void Function(PageUserBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PageUser build() => _build();
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PageUser', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
