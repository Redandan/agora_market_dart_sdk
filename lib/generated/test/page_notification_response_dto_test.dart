...
// tests for PageNotificationResponseDTO
void main() {
  // final instance = PageNotificationResponseDTO();

  group('test PageNotificationResponseDTO', () {
    // int totalPages
    ...
    // List<NotificationResponseDTO> content (default value: const [])
