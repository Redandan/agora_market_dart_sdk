...
*WalletConnectWebviewApi* | [**getConnectPage**](doc//WalletConnectWebviewApi.md#getconnectpage) | **GET** /auth/wallet-connect/connect | 获取 WalletConnect 连接页面
*WalletConnectWebviewApi* | [**getNonce**](doc//WalletConnectWebviewApi.md#getnonce) | **GET** /auth/wallet-connect/session/nonce | 获取 Nonce
*WalletConnectWebviewApi* | [**onWalletConnected**](doc//WalletConnectWebviewApi.md#onwalletconnected) | **POST** /auth/wallet-connect/session/connected | 钱包连接成功回调
*WalletConnectWebviewApi* | [**verifySignature**](doc//WalletConnectWebviewApi.md#verifysignature) | **POST** /auth/wallet-connect/session/verify | 验证签名并登录
